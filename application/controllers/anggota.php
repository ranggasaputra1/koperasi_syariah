...
class Anggota extends ketuaController {
	...
	public function index() {
		...
		$crud->columns('file_pic','id_anggota','identitas','nama','jk','alamat','kota','jabatan_id','Status Guru','tgl_daftar','aktif');
		$crud->fields('nama','identitas','jk', 'tmp_lahir','tgl_lahir','status','Status Guru','pekerjaan','agama','alamat','kota','notelp','tgl_daftar', 'jabatan_id','pass_word','aktif','file_pic');
		...
		$crud->display_as('Status Guru','Status Guru');
		...
		// Status Guru
		$crud->field_type('Status Guru','dropdown',
			array(
				'' 						=> '',
				'PNS' 		=> 'PNS',
				'Non PNS' 			=> 'Non PNS'
